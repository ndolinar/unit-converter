...
- (void)viewDidLoad
{
    ...
    self.UCButtons = @[self.lengthButton, self.weightButton, self.volumeButton, self.areaButton, self.speedButton, self.tempButton, self.timeButton, self.angleButton];
